...
file_path <- "./results/RReliefF_plsr/sideviewA/CN_N2_model"
```
...
RReliefF_star = RReliefF[order(RReliefF$value, decreasing = T)[1:300],]
tail(RReliefF_star)
```
...
write.csv(x=RReliefF, 
          file = paste0(file_path, "/CN_N2_RReliefF_300.csv"), 
          row.names = F)

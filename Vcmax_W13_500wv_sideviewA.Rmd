...
file_path <- "./results/RReliefF_plsr/sideviewA/Vcmax_W13_n_500_wv"
```
...
RReliefF_star =  RReliefF[order(RReliefF$value, decreasing = T)[1:500], ] 
tail(RReliefF_star)
```
...
write.csv(x=RReliefF, 
          file = paste0(file_path, "/Vcmax_W13_RReliefF_500.csv"), 
          row.names = F)

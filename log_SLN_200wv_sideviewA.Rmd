...
file_path <- "./results/RReliefF_plsr/sideviewA/log_SLN_n_200_wv"
```
...
RReliefF_star =  RReliefF[order(RReliefF$value, decreasing = T)[1:200], ] 
tail(RReliefF_star)
```
...
write.csv(x=RReliefF, 
          file = paste0(file_path, "/log_SLN_RReliefF_200.csv"), 
          row.names = F)

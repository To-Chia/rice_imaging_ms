...
file_path <- "./results/RReliefF_plsr/sideviewA/log_gsw_n_90_wv"
```
...
RReliefF_star =  RReliefF[order(RReliefF$value, decreasing = T)[1:90], ] 
tail(RReliefF_star)
```
...
write.csv(x=RReliefF, 
          file = paste0(file_path, "/log_gsw_RReliefF_90.csv"), 
          row.names = F)
